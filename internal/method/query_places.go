...
type queryPlacesArgs struct {
	...
	Predicate string  `query:"predicate" required:"true" doc:"JSON Path filter expression using PostgreSQL dialect to filter **Places** in the bounding-box by their OpenStreetMap [tags](https://wiki.openstreetmap.org/wiki/Tags)." example:"$.amenity == \"restaurant\" && $.cuisine like_regex \"turkish\" && $.outdoor_seating == \"yes\""`
}
